...
# To install it, read the service's YAML file (nodeRoot/services/name.yml) and add it to the main compose file (nodeRoot/docker-compose.yml.citadel)
def setService(name, implementation):
    ...
    with open(os.path.join(nodeRoot, "docker-compose.yml.citadel"), 'r') as stream:
    ...
    with open(os.path.join(nodeRoot, "docker-compose.yml.citadel"), 'w') as stream:
